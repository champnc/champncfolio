...
const ContactSection = () => {
  return (
    <div className="bg-gray-800 flex justify-center py-4">
      <div className="flex justify-center flex w-2/3 md:w-1/3">
        <form
          name="contact form"
          className="contactForm items-center 
              justify-center w-full"
        >
          <h1 className="text-white mt-4 mx-4 text-3xl">
          ...
          <textarea
            ...
            className="m-4 w-full h-24 rounded-xl p-4"
          ></textarea>
          <br />
          <button
            type="submit"
            className="m-4 w-full rounded-xl text-gray-800 bg-gray-200 h-12 font-bold"
          >
            Submit
          </button>
        </form>
